...
Il est possible de lier la résistivité ($\rho_{ele}$) d'un matériau à sa conductivité ($\sigma_{ele}$) en Siemens par mètre à l'aide de l'équation suivante :

\begin{equation}
\sigma_{ele} = \frac{1}{\rho_{ele}}
\end{equation}
