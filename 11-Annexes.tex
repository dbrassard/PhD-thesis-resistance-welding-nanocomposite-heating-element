...
Dans le cadre de cette thèse, la stabilité thermique de l'élastomère SEBS a été jugée suffisamment bonne pour tenter de réaliser des jonctions soudées. 
...
\begin{table}[h]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{@{}lllrlrl@{}}
			...
			Electrical conductivity & $\sigma_{ele}$          & [\si{\siemens\per\metre}]               & \num{1e-15} &                     & \num{8.3e5} & \cite{Ebbesen1996}        \\
